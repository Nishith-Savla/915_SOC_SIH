...
function App() {
	...
	return (
			...
			<ThemeProvider theme={mdTheme}>
				<Box sx={{ display: "flex", background: "#e8d3f5", opacity: "1" }}>
					...
					<AppBar position="absolute" sx={{ background: "#7607ba", height: "8%" }}>
						...
						>
							<Typography component="h1" variant="h4" color="inherit" noWrap sx={{ flexGrow: 0.5 }}>
								Dashboard
							</Typography>
      ...
      Logout
																	...
																	>
																		...
																		>
																			<Typography
																				component="span"
																				variant="h5"
																				sx={{ color: "black", pl: 3.5, fontSize: "1.25rem" }}
																			>
																				IT
																			</Typography>
																			<Typography
																				component="span"
																				variant="h4"
																				sx={{ color: "black", pl: 4, fontSize: "1.25rem" }}
																			>
																				{itCount}
																			</Typography>
																		</Stack>
																		...
																		>
																			...
																			<Typography
																				component="span"
																				variant="h4"
																				sx={{ color: "black", pl: 5, fontSize: "1.25rem" }}
																			>
																				{otCount}
																			</Typography>
																		</Stack>
                    ...
                    Asset Identification
                          ...
                          >
                            Browse
										...
										{spinnerloading == true && <CircularProgress />}
									</Stack>
								</Stack>
							</DialogContent>
							<DialogActions>
				...
				<Dialog open={openDiagram} onClose={handleCloseDiagram} fullWidth={true} maxWidth={"lg"}>
				...
				<Dialog open={openLoading} onClose={handleCloseLoading} fullWidth={true} maxWidth={"sm"}>
