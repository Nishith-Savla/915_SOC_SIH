				...
				<Box sx={{ display: "flex", background: "#b0e2ff", opacity: "1" }}>
					...
					<AppBar position="absolute" sx={{ background: "#026ced", height: "55px" }}>
						...
						>
							...
							<Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: -1 }}>
								<Button variant="outlined" sx={{ color: "white" }} component={Link} to="/kibana">
									Log Analysis
								</Button>
							</Typography>

							<Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: -1 }}>
								<Button variant="outlined" sx={{ color: "white" }} component={Link} to="/">
									Logout
								</Button>
							</Typography>
						</Toolbar>
